...
// {
struct MapView_type : ::g::Fuse::Controls::Native::iOS::View_type
{
...
struct MapView : ::g::Fuse::Controls::Native::iOS::LeafView
{
    ...
    int AddMarker(int uid, uString* label, double lat, double lng, uString* iconPath, float iconAnchorX, float iconAnchorY);
    bool AllowRotate();
