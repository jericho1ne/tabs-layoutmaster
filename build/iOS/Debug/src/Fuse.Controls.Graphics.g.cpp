...
// /usr/local/share/uno/Packages/Fuse.Controls/1.4.0/Graphics/ControlVisual.uno
// ----------------------------------------------------------------------------
...
static void ControlVisual_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(ControlVisual_type, interface7),
...
// /usr/local/share/uno/Packages/Fuse.Controls/1.4.0/Graphics/Visual.uno
// ---------------------------------------------------------------------
...
static void Visual_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(::g::Fuse::Visual_type, interface7),
