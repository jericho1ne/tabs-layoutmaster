...
static void Dictionary_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(type->T(0), type->T(1), NULL), NULL), offsetof(Dictionary_type, interface0),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Collections::KeyValuePair_typeof()->MakeType(type->T(0), type->T(1), NULL), NULL), offsetof(Dictionary_type, interface1));
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.0/Internal/PriorityQueue.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.0/Internal/RootableList.uno
// -------------------------------------------------------------------------
