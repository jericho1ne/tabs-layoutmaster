...
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} ::g::Fuse::Controls::TextControl_type* H1Text_typeof();}
namespace g{namespace Fuse{struct AppBase_type;} ::g::Fuse::AppBase_type* MainView_typeof();}
namespace g{namespace Fuse{namespace Controls{struct TextControl_type;}} ::g::Fuse::Controls::TextControl_type* ParagraphText_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* Tab_typeof();}
namespace g{namespace Uno{namespace UX{struct PropertyAccessor_type;}} ::g::Uno::UX::PropertyAccessor_type* TabsLayoutMaster_accessor_Tab_Text_typeof();}
namespace g{uClassType* TabsLayoutMaster_bundle_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* TabsLayoutMaster_FuseControlsNavigationControl_Active_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* TabsLayoutMaster_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* TabsLayoutMaster_FuseElementsElement_ElementLayoutMaster_Property_typeof();}
...
namespace g{namespace Fuse{namespace Scripting{uType* ScriptPromise_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uType* MapEventArgs_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uType* MarkerEventArgs_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Module_type;}} namespace Fuse{namespace ImageTools{::g::Fuse::Scripting::Module_type* ImageTools_typeof();}}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::H1Text_typeof,
        (uType*(*)())&::g::MainView_typeof,
        (uType*(*)())&::g::ParagraphText_typeof,
        (uType*(*)())&::g::Tab_typeof,
        (uType*(*)())&::g::TabsLayoutMaster_accessor_Tab_Text_typeof,
        (uType*(*)())&::g::TabsLayoutMaster_bundle_typeof,
        (uType*(*)())&::g::TabsLayoutMaster_FuseControlsNavigationControl_Active_Property_typeof,
        (uType*(*)())&::g::TabsLayoutMaster_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::TabsLayoutMaster_FuseElementsElement_ElementLayoutMaster_Property_typeof,
