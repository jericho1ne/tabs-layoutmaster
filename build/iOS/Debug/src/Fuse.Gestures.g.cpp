...
static void ScrollTo_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.4.0/Scroller.Actions.uno");
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Fuse.Gestures/1.4.0/Swipe.uno");
