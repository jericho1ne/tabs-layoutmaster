// This file was generated based on /Users/mpeteu/Sites/tabs-layoutmaster/.uno/ux13/H1Text.g.uno.
...
// public partial sealed class H1Text :2
// {
// static H1Text() :4
static void H1Text__cctor_4_fn(uType* __type)
{
}

static void H1Text_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextControl_type* H1Text_typeof()
{
    ...
    options.ObjectSize = sizeof(H1Text);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("H1Text", options);
    type->fp_build_ = H1Text_build;
    type->fp_ctor_ = (void*)H1Text__New4_fn;
    type->fp_cctor_ = H1Text__cctor_4_fn;
...
// public H1Text() :8
void H1Text__ctor_8_fn(H1Text* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void H1Text__InitializeUX1_fn(H1Text* __this)
{
    __this->InitializeUX1();
}

// public H1Text New() :8
void H1Text__New4_fn(H1Text** __retval)
{
    *__retval = H1Text::New4();
}

// public H1Text() [instance] :8
void H1Text::ctor_8()
{
    ctor_7();
    InitializeUX1();
...
// public H1Text New() [static] :8
H1Text* H1Text::New4()
{
    H1Text* obj1 = (H1Text*)uNew(H1Text_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
