...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/VarArgFunction.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/BinaryOperator.uno
// --------------------------------------------------------------------------------
...
{
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)this, Compute(left, right));
}
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/DataBinding.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/MathFunctions.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/Operators.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/Expression.uno
// ----------------------------------------------------------------------------
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[6/*"'"*/], ::g::Uno::Object::ToString(uPtr(__this->Value()))), ::STRINGS[6/*"'"*/]), void();
}
...
{
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)__this, __this->GetValue(context));
    return *__retval = NULL, void();
}
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Instance.API.uno
// ---------------------------------------------------------------------------
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[7/*"{"*/], __this->Key()), ::STRINGS[8/*"}"*/]), void();
}
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("Cannot bind '");
    ::STRINGS[11] = uString::Const("' to property '");
    ::STRINGS[12] = uString::Const("'. The observable must contain exactly one ");
    ::STRINGS[13] = uString::Const(".");
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/DataBinding.uno");
    ::STRINGS[15] = uString::Const("InvalidListOperation");
    ::STRINGS[16] = uString::Const("TryPushAsMarshalledValue");
    ::STRINGS[17] = uString::Const("number");
    ::STRINGS[18] = uString::Const("string");
    ::STRINGS[19] = uString::Const("value that can be converted to type ");
    ::TYPES[4] = ::g::Fuse::IArray_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ...
    type->SetFields(3,
        ...
        ::TYPES[8/*string*/], offsetof(DataBinding, _registryName), 0,
...
{
    if (::g::Fuse::IArray::Length(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/])) > 0)
...
void DataBinding__NewValue_fn(DataBinding* __this, uObject* value)
{
    ...
    else if (::g::Fuse::Marshal::Is(value, ::TYPES[20/*Fuse.Reactive.IObservable*/]))
    {
        uObject* obs = (uObject*)value;

        if (::g::Fuse::IArray::Length(uInterface(uPtr(obs), ::TYPES[4/*Fuse.IArray*/])) > 0)
            __this->PushValue(::g::Fuse::IArray::Item(uInterface(uPtr(obs), ::TYPES[4/*Fuse.IArray*/]), 0));

        __this->_subscription = ::g::Fuse::Reactive::IObservableArray::Subscribe(uInterface(uPtr(obs), ::TYPES[6/*Fuse.Reactive.IObservableArray*/]), (uObject*)__this);
    }
    else
        __this->PushValue(value);
}
...
void DataBinding__UnoUXIPropertyListenerOnPropertyChanged_fn(DataBinding* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    if (::g::Uno::UX::Selector__op_Equality(prop_, uPtr(__this->Target())->Name()))
    {
        if (__this->_subscription != NULL)
        {
            if (__this->Write())
            {
                uObject* sub = uAs<uObject*>(__this->_subscription, ::TYPES[11/*Fuse.Reactive.ISubscription*/]);

                if (sub != NULL)
                    ::g::Fuse::Reactive::ISubscription::SetExclusive(uInterface(uPtr(sub), ::TYPES[11/*Fuse.Reactive.ISubscription*/]), uPtr(__this->Target())->GetAsObject1());
            }
        }
...
{
    ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[10/*"Cannot bind '"*/], Key()), ::STRINGS[11/*"' to proper...*/]), ::g::Uno::UX::Selector__op_Implicit1(uPtr(Target())->Name())), ::STRINGS[12/*"'. The obse...*/]), DataBinding::TypeToJSName(uPtr(Target())->PropertyType())), ::STRINGS[13/*"."*/]), this, ::STRINGS[14/*"/usr/local/...*/], 90, ::STRINGS[15/*"InvalidList...*/], NULL);
}
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[14/*"/usr/local/...*/], 317, ::STRINGS[16/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
bool DataBinding::TryPushAsName(uObject* newValue)
{
    ...
    if (!name.IsNull())
    {
        ...
        ::g::Fuse::Node* k = uPtr(Parent())->FindNodeByName(name, uDelegate::New(::TYPES[10/*Uno.Predicate<Fuse.Node>*/], (void*)DataBinding__Acceptor_fn, this));
...
{
    return uIs(newValue, ::TYPES[7/*Uno.UX.Selector*/]) ? uUnbox< ::g::Uno::UX::Selector>(::TYPES[7/*Uno.UX.Selector*/], newValue) : uIs(newValue, ::TYPES[8/*string*/]) ? ::g::Uno::UX::Selector__New1(uCast<uString*>(newValue, ::TYPES[8/*string*/])) : uDefault< ::g::Uno::UX::Selector>();
}

// private static string TypeToJSName(Uno.Type t) [static] :81
uString* DataBinding::TypeToJSName(uType* t)
{
    if ((::g::Uno::Type::op_Equality(t, ::g::Uno::Int_typeof()) || ::g::Uno::Type::op_Equality(t, ::g::Uno::Float_typeof())) || ::g::Uno::Type::op_Equality(t, ::g::Uno::Double_typeof()))
        return ::STRINGS[17/*"number"*/];

    if (::g::Uno::Type::op_Equality(t, ::TYPES[8/*string*/]))
        return ::STRINGS[18/*"string"*/];

    return ::g::Uno::String::op_Addition2(::STRINGS[19/*"value that ...*/], ::g::Uno::Type::FullName(uPtr(t)));
}
// }

// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Subscription/DataSubscription.uno
// --------------------------------------------------------------------------------------------
...
{
    ::STRINGS[7] = uString::Const("{");
    ::STRINGS[20] = uString::Const("} not found in data context");
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[12] = ::g::Fuse::Reactive::IPropertySubscription_typeof();
    ::TYPES[13] = ::g::Fuse::Reactive::IObservableObject_typeof();
    ::TYPES[2] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
    ...
    type->SetFields(1,
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(DataSubscription, _listener), 0,
        ...
        ::TYPES[12/*Fuse.Reactive.IPropertySubscription*/], offsetof(DataSubscription, _sub), 0);
}
...
{
    uObject* w = uAs<uObject*>(__this->_sub, ::TYPES[12/*Fuse.Reactive.IPropertySubscription*/]);

    if (w != NULL)
        return *__retval = ::g::Fuse::Reactive::IPropertySubscription::TrySetExclusive(uInterface(uPtr(w), ::TYPES[12/*Fuse.Reactive.IPropertySubscription*/]), __this->Key(), newValue), void();
...
{
    __this->DisposeSubscription();
    uObject* obs = uAs<uObject*>(provider, ::TYPES[13/*Fuse.Reactive.IObservableObject*/]);

    if (obs != NULL)
        __this->_sub = ::g::Fuse::Reactive::IObservableObject::Subscribe(uInterface(uPtr(obs), ::TYPES[13/*Fuse.Reactive.IObservableObject*/]), (uObject*)__this);
...
void DataSubscription::FindData()
{
    ...
    if (!_isResolved)
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[7/*"{"*/], Key()), ::STRINGS[20/*"} not found...*/]), _origin);
}
...
void DataSubscription::ResolveInner(uObject* data)
{
    ...
    {
        _currentData = data;
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), _source, data);
    }
}
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/EventBinding.uno
// ---------------------------------------------------------------------------
...
{
    ::TYPES[14] = ::g::Fuse::Reactive::IEventHandler_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(3,
        ::TYPES[14/*Fuse.Reactive.IEventHandler*/], offsetof(EventBinding, _eventHandler), 0,
...
{
    __this->_eventHandler = uAs<uObject*>(obj, ::TYPES[14/*Fuse.Reactive.IEventHandler*/]);
...
void EventBinding::ProcessQueuedEvents()
{
    ...
    if ((_eventHandler != NULL) && (_queuedEvents != NULL))
    {
        ...
        for (int i = 0; i < uPtr(events)->Count(); i++)
            ::g::Fuse::Reactive::IEventHandler::Dispatch(uInterface(uPtr(_eventHandler), ::TYPES[14/*Fuse.Reactive.IEventHandler*/]), (uObject*)(::g::Uno::Collections::List__get_Item_fn(uPtr(events), uCRef<int>(i), &ret2), ret2));
    }
}
// }

// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/EventRecord.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/ExpressionBinding.uno
// --------------------------------------------------------------------------------
...
{
    ::STRINGS[21] = uString::Const("The binding type does not support resource subscriptions");
    ::TYPES[15] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[16] = ::g::Fuse::Reactive::IWriteable_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(1,
        ...
        ::TYPES[15/*Fuse.Reactive.IExpression*/], offsetof(ExpressionBinding, _Key), 0);
}
...
void ExpressionBinding__OnRooted_fn(ExpressionBinding* __this)
{
    ...
    __this->_expressionSub = ::g::Fuse::Reactive::IExpression::Subscribe(uInterface(uPtr(__this->Key()), ::TYPES[15/*Fuse.Reactive.IExpression*/]), (uObject*)__this, (uObject*)__this);
}
...
{
    U_THROW(::g::Uno::Exception::New2(::STRINGS[21/*"The binding...*/]));
}
...
{
    return uIs((uObject*)_expressionSub, ::TYPES[16/*Fuse.Reactive.IWriteable*/]);
}
...
{
    ::g::Fuse::Reactive::IWriteable::TrySetExclusive(uInterface(uPtr(_expressionSub), ::TYPES[16/*Fuse.Reactive.IWriteable*/]), value);
}
// }

// /usr/local/share/uno/Packages/Fuse.Reactive/1.4.0/IExpression.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive/1.4.0/IEventHandler.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/Subscription.uno
// ------------------------------------------------------------------------------
...
void InnerListener__Dispose_fn(InnerListener* __this)
{
    ...
    if (__this->_obsSubs != NULL)
    {
        ...
        {
            {
                while (enum1.MoveNext(::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::TYPES[15/*Fuse.Reactive.IExpression*/], InnerListener__ObservableSubscription_typeof(), NULL)))
                {
                    InnerListener__ObservableSubscription* k = enum1.Current(::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::TYPES[15/*Fuse.Reactive.IExpression*/], InnerListener__ObservableSubscription_typeof(), NULL));
                    uPtr(k)->Dispose();
                }
            }
            {
                enum1.Dispose(::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::TYPES[15/*Fuse.Reactive.IExpression*/], InnerListener__ObservableSubscription_typeof(), NULL));
            }
        }
...
void InnerListener__FuseReactiveIListenerOnNewData_fn(InnerListener* __this, uObject* source, uObject* value)
{
    ...
    uObject* obs = uAs<uObject*>(value, ::TYPES[20/*Fuse.Reactive.IObservable*/]);

    if (obs != NULL)
    {
        if (__this->_obsSubs == NULL)
            __this->_obsSubs = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[15/*Fuse.Reactive.IExpression*/], InnerListener__ObservableSubscription_typeof(), NULL)));
...
// public partial sealed class Instantiator :53
// {
...
Instantiator_type* Instantiator_typeof()
{
    ...
    type->interface4.fp_OnNewAll = (void(*)(uObject*, uObject*))Instantiator__FuseReactiveIObserverOnNewAll_fn;
...
bool Instantiator::AddMatchingTemplates(Instantiator__WindowItem* item, Instantiator__TemplateMatch f)
{
    ...
    {
        uPtr(item)->Nodes = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[23/*Uno.Collections.List`1*/]->MakeType(::TYPES[18/*Fuse.Node*/], NULL)));
...
{
    ::g::Fuse::Node* elm = uAs< ::g::Fuse::Node*>(uPtr(f)->New1(), ::TYPES[18/*Fuse.Node*/]);

    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Template contains a non-Node"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Instance.WindowItems.uno"), 263, uString::Const("AddTemplate"));
        return;
    }
...
void Instantiator::CompleteNodeAction()
{
    if (Reuse() == 1)
    {
        ...
        {
            ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)Instantiator__RemovePendingAvailableItemsAction_fn, this), -1, 2);
...
void Instantiator::CompleteWindowItem(Instantiator__WindowItem* wi, int windowIndex)
{
    ...
    if ((wi->Template.All && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL))) != uPtr(wi->Nodes)->Count())) || ((wi->Template.Template != NULL) && (uPtr(wi->Nodes)->Count() != 1)))
        ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent instance state"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Instance.WindowItems.uno"), 176, uString::Const("CompleteWindowItem"));

    ::g::Fuse::Node* lastNode = GetLastNodeFromIndex(windowIndex - 1);

    if (reuse)
        uPtr(Parent())->InsertOrMoveNodesAfter(lastNode, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[18/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(uPtr(wi)->Nodes), &ret9), ret9)));
    else
        uPtr(Parent())->InsertNodesAfter(lastNode, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[18/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(uPtr(wi)->Nodes), &ret10), ret10)));
}
...
uObject* Instantiator::GetData(int dataIndex)
{
    ...
    uObject* a = uAs<uObject*>(_items, ::TYPES[4/*Fuse.IArray*/]);

    if (a != NULL)
        return ::g::Fuse::IArray::Item(uInterface(uPtr(a), ::TYPES[4/*Fuse.IArray*/]), dataIndex);
...
int Instantiator::GetDataCount()
{
    ...
    if (a != NULL)
        return ::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[4/*Fuse.IArray*/]));
...
{
    uObject* so = uAs<uObject*>(data, ::TYPES[22/*Fuse.IObject*/]);

    if ((so != NULL) && ::g::Uno::String::op_Inequality(key, NULL))
    {
        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(so), ::TYPES[22/*Fuse.IObject*/]), key))
            return ::g::Fuse::IObject::Item(uInterface(uPtr(so), ::TYPES[22/*Fuse.IObject*/]), key);
    }
...
Instantiator__TemplateMatch Instantiator::GetDataTemplate(uObject* data)
{
    ...
    if (useTemplate == NULL)
    {
        uString* key = uAs<uString*>(GetDataKey(data, MatchKey()), ::TYPES[8/*string*/]);
...
void Instantiator::InsertNewWindowItem(int windowIndex, uObject* data)
{
    ...
    else if (!_pendingNew)
    {
        if (Defer() == 2)
            ...
            ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)Instantiator__CompleteWindowItemsAction_fn, this), -1, 2);
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Limit cannot be less than 0"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Instance.API.uno"), 286, uString::Const("set_Limit"), NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Offset cannot be less than 0"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Instance.API.uno"), 238, uString::Const("set_Offset"), NULL);
        value = 0;
    }
...
void Instantiator::OnUpdatedWindowItems()
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)Instantiator__PostUpdatedWindowItems_fn, this), -1, 2);
}
...
void Instantiator::PatchTo(uObject* values)
{
    ...
    ::g::Uno::Collections::List* newIds = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[23/*Uno.Collections.List`1*/]->MakeType(uObject_typeof(), NULL));
    int limit = CalcOffsetLimitCountOf(::g::Fuse::IArray::Length(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/])));

    for (int i = 0; i < limit; ++i)
        ::g::Uno::Collections::List__Add_fn(uPtr(newIds), GetDataId(::g::Fuse::IArray::Item(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/]), i + Offset())));

    ::g::Uno::Collections::List* curIds = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[23/*Uno.Collections.List`1*/]->MakeType(uObject_typeof(), NULL));
    ...
    for (int i2 = 0; i2 < uPtr(ops)->Count(); ++i2)
    {
        ...
        switch (op.Op)
        {
            ...
            case 1:
            {
                InsertNewWindowItem(DataToWindowIndex(op.A + Offset()), ::g::Fuse::IArray::Item(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/]), op.Data));
                break;
            }
            case 2:
            {
                if (!TryUpdateAt(op.A + Offset(), ::g::Fuse::IArray::Item(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/]), op.Data)))
                {
                    RemoveAt(op.A + Offset());
                    InsertNewWindowItem(DataToWindowIndex(op.A + Offset()), ::g::Fuse::IArray::Item(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/]), op.Data));
                }
...
void Instantiator::RefreshItems()
{
    ...
    Repopulate();
    uObject* obs = uAs<uObject*>(_items, ::TYPES[6/*Fuse.Reactive.IObservableArray*/]);

    if (obs != NULL)
    {
        StartListeningItems();
        _itemsSubscription = ::g::Fuse::Reactive::IObservableArray::Subscribe(uInterface(uPtr(obs), ::TYPES[6/*Fuse.Reactive.IObservableArray*/]), (uObject*)this);
    }
}
...
void Instantiator::RemoveFromParent(::g::Fuse::Node* n)
{
    if (::g::Uno::Delegate::op_Equality(_completedRemove, NULL))
        _completedRemove = uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[18/*Fuse.Node*/], NULL), (void*)Instantiator__CompletedRemove_fn, this);
...
void Instantiator::Repopulate()
{
    ...
    else
    {
        ...
        if (a != NULL)
            ...
            for (int i1 = 0; i1 < ::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[4/*Fuse.IArray*/])); i1++)
                InsertNew(i1);
    }
...
void Instantiator::UpdateData(Instantiator__WindowItem* item, uObject* oldData)
{
    ...
    uObject* obs = uAs<uObject*>(uPtr(item)->Data, ::TYPES[20/*Fuse.Reactive.IObservable*/]);
...
{
    UpdatedWindowItems1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(UpdatedWindowItems1, value), ::TYPES[17/*Uno.Action*/]);
}
...
{
    UpdatedWindowItems1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(UpdatedWindowItems1, value), ::TYPES[17/*Uno.Action*/]);
}
// }

// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/InstantiatorFunction.uno
// -----------------------------------------------------------------------------------
...
void InstantiatorFunction__Subscribe_fn(InstantiatorFunction* __this, uObject* context, uObject* listener, uObject** __retval)
{
    ...
    if (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Arguments()), ::TYPES[28/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])) > 1)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("too many parameters for "), ::g::Uno::UX::Selector__op_Implicit1(__this->_item)), __this, ::STRINGS[23/*"/usr/local/...*/], 34, uString::Const("Subscribe"), NULL);
        return *__retval = NULL, void();
    }

    ::g::Fuse::Reactive::Expression* node = (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Arguments()), ::TYPES[28/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])) > 0) ? (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Arguments()), ::TYPES[29/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(0), &ret1), ret1) : NULL;
...
{
    ::STRINGS[22] = uString::Const("invalid search node for InstantiatorFunction");
    ::STRINGS[23] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/InstantiatorFunction.uno");
    ::STRINGS[24] = uString::Const("OnNewNode");
    ::STRINGS[25] = uString::Const("Could not find an Instantiator");
    ::STRINGS[26] = uString::Const("Unable to resolve Instantiator node");
    ::TYPES[15] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[17] = ::g::Uno::Action_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[18] = ::g::Fuse::Node_typeof();
    ::TYPES[3] = ::g::Fuse::Reactive::IContext_typeof();
    ::TYPES[19] = ::TYPES[18/*Fuse.Node*/]->MakeMethod(0/*FindBehavior<Fuse.Reactive.Instantiator>*/, ::g::Fuse::Reactive::Instantiator_typeof(), NULL);
    ::TYPES[2] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
    ...
    type->SetInterfaces(
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(::g::Fuse::Reactive::InnerListener_type, interface1));
    type->SetFields(2,
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(InstantiatorFunction__InstantiatorSubscription, _listener), 0,
        ::TYPES[3/*Fuse.Reactive.IContext*/], offsetof(InstantiatorFunction__InstantiatorSubscription, _context), 0,
        ::TYPES[15/*Fuse.Reactive.IExpression*/], offsetof(InstantiatorFunction__InstantiatorSubscription, _node), 0,
        ::g::Fuse::Reactive::Instantiator_typeof(), offsetof(InstantiatorFunction__InstantiatorSubscription, _instantiator), 0,
        ::TYPES[18/*Fuse.Node*/], offsetof(InstantiatorFunction__InstantiatorSubscription, _instance), 0,
...
void InstantiatorFunction__InstantiatorSubscription__Dispose_fn(InstantiatorFunction__InstantiatorSubscription* __this)
{
    ...
    if (__this->_instantiator != NULL)
        uPtr(__this->_instantiator)->remove_UpdatedWindowItems(uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)InstantiatorFunction__InstantiatorSubscription__OnUpdatedWindowItems_fn, __this));
...
void InstantiatorFunction__InstantiatorSubscription::ctor_1(::g::Fuse::Reactive::InstantiatorFunction* expr, ::g::Uno::UX::Selector item, uObject* listener, uObject* context, uObject* node)
{
    ...
    if (_node == NULL)
        ...
        _nodeSub = ::g::Fuse::Reactive::IExpression::Subscribe(uInterface(uPtr(_node), ::TYPES[15/*Fuse.Reactive.IExpression*/]), context, (uObject*)this);
}
...
void InstantiatorFunction__InstantiatorSubscription::OnNewNode(uObject* obj)
{
    ...
    {
        uPtr(_instantiator)->remove_UpdatedWindowItems(uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)InstantiatorFunction__InstantiatorSubscription__OnUpdatedWindowItems_fn, this));
        _instantiator = NULL;
        _instance = NULL;
    }

    ind1 = uAs< ::g::Fuse::Node*>(obj, ::TYPES[18/*Fuse.Node*/]);
    ...
    if (searchNode == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"invalid sea...*/], this, ::STRINGS[23/*"/usr/local/...*/], 92, ::STRINGS[24/*"OnNewNode"*/], NULL);
        return;
    }

    _instantiator = ((::g::Fuse::Reactive::Instantiator*)uPtr(searchNode)->FindBehavior(::TYPES[19/*Fuse.Node.FindBehavior<Fuse.Reactive.Instantiator>*/]));

    if (_instantiator == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[25/*"Could not f...*/], this, ::STRINGS[23/*"/usr/local/...*/], 99, ::STRINGS[24/*"OnNewNode"*/], NULL);
        return;
    }
    ...
    if (p == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Unable to r...*/], this, ::STRINGS[23/*"/usr/local/...*/], 110, ::STRINGS[24/*"OnNewNode"*/]);
        return;
    }
    ...
    {
        _instance = p;
        uPtr(_instantiator)->add_UpdatedWindowItems(uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)InstantiatorFunction__InstantiatorSubscription__OnUpdatedWindowItems_fn, this));
        PushValue();
    }
}
...
void InstantiatorFunction__InstantiatorSubscription::PushValue()
{
    ...
    if (q != -1)
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)_expr, uBox<int>(::g::Uno::Int_typeof(), q));
}
...
// /usr/local/share/uno/Packages/Fuse.Reactive/1.4.0/IObservable.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive/1.4.0/ValueObserver.uno
// -------------------------------------------------------------------
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[27/*"lerp("*/], __this->First()), ::STRINGS[1/*","*/]), __this->Second()), ::STRINGS[1/*","*/]), __this->Third()), ::STRINGS[2/*")"*/]), void();
}
// }

// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/LookUp.uno
// ------------------------------------------------------------------------
...
{
    ::STRINGS[28] = uString::Const("Index must be a number: ");
    ::STRINGS[29] = uString::Const("Index was outside the bounds of the array");
    ::STRINGS[30] = uString::Const("Object does not contain the given key '");
    ::STRINGS[6] = uString::Const("'");
    ::STRINGS[31] = uString::Const("Look-up operator not supported on collection type: ");
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[6] = ::g::Fuse::Reactive::IObservableArray_typeof();
    ::TYPES[20] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[2] = ::g::Fuse::Reactive::IListener_typeof();
    ::TYPES[4] = ::g::Fuse::IArray_typeof();
    ::TYPES[21] = ::g::Fuse::MarshalException_typeof();
    ::TYPES[22] = ::g::Fuse::IObject_typeof();
    ::TYPES[13] = ::g::Fuse::Reactive::IObservableObject_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(LookUp__LookUpSubscription_type, interface2),
    ...
    type->SetFields(0,
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(LookUp__LookUpSubscription, _listener), 0,
...
void LookUp__LookUpSubscription::NewCollection(uObject* col)
{
    ...
    DisposeCollectionObservableObjectSub();
    DisposeCollectionObservableSub();
    uObject* obs = uAs<uObject*>(col, ::TYPES[6/*Fuse.Reactive.IObservableArray*/]);

    if (obs != NULL)
        _colObservableSub = ::g::Fuse::Reactive::IObservableArray::Subscribe(uInterface(uPtr(obs), ::TYPES[6/*Fuse.Reactive.IObservableArray*/]), (uObject*)this);
...
{
    DisposeIndexSub();
    uObject* obs = uAs<uObject*>(ind, ::TYPES[20/*Fuse.Reactive.IObservable*/]);
...
{
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)_lu, value);
}
...
void LookUp__LookUpSubscription::ResultChanged()
{
    ...
    uObject* arr = uAs<uObject*>(_collection, ::TYPES[4/*Fuse.IArray*/]);
    ...
    if (arr != NULL)
    {
        ...
        {
            if (uIs(__t.Exception, ::TYPES[21/*Fuse.MarshalException*/]))
            {
                ::g::Fuse::MarshalException* me = (::g::Fuse::MarshalException*)__t.Exception;
                SetDiagnostic(::g::Uno::String::op_Addition2(::STRINGS[28/*"Index must ...*/], uPtr(me)->Message()), (uObject*)uPtr(_lu)->Index());
                return;
            }
            else             throw __t;
        }

        if ((index >= 0) && (index < ::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[4/*Fuse.IArray*/]))))
            PushNewData(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[4/*Fuse.IArray*/]), index));
        else
            SetDiagnostic(::STRINGS[29/*"Index was o...*/], (uObject*)uPtr(_lu)->Index());

        return;
    }

    uObject* obj = uAs<uObject*>(_collection, ::TYPES[22/*Fuse.IObject*/]);

    if (obj != NULL)
    {
        uObject* obsObj = uAs<uObject*>(obj, ::TYPES[13/*Fuse.Reactive.IObservableObject*/]);

        if (obsObj != NULL)
            _colObsObjSub = ::g::Fuse::Reactive::IObservableObject::Subscribe(uInterface(uPtr(obsObj), ::TYPES[13/*Fuse.Reactive.IObservableObject*/]), (uObject*)this);

        uString* key = ::g::Uno::Object::ToString(uPtr(_index));

        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(obj), ::TYPES[22/*Fuse.IObject*/]), key))
            PushNewData(::g::Fuse::IObject::Item(uInterface(uPtr(obj), ::TYPES[22/*Fuse.IObject*/]), key));
        else
            SetDiagnostic(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[30/*"Object does...*/], key), ::STRINGS[6/*"'"*/]), (uObject*)uPtr(_lu)->Index());

        return;
    }

    SetDiagnostic(::g::Uno::String::op_Addition1(::STRINGS[31/*"Look-up ope...*/], _collection), (uObject*)uPtr(_lu)->Collection());
}
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/NodeExpressionBinding.uno
// ------------------------------------------------------------------------------------
...
{
    ::STRINGS[32] = uString::Const("Invalid params");
    ::STRINGS[21] = uString::Const("The binding type does not support resource subscriptions");
    ::TYPES[17] = ::g::Uno::Action_typeof();
    ::TYPES[15] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ...
    type->SetFields(0,
        ::TYPES[15/*Fuse.Reactive.IExpression*/], offsetof(NodeExpressionBinding, _expr), 0,
...
void NodeExpressionBinding::ctor_(uObject* expr, ::g::Fuse::Node* node, uObject* listener)
{
    if (((expr == NULL) || (node == NULL)) || (listener == NULL))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[32/*"Invalid par...*/]));

    _expr = expr;
    _listener = listener;
    _node = node;
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)NodeExpressionBinding__CompleteInit_fn, this), -1, 2);
}
...
void NodeExpressionBinding::CompleteInit()
{
    ...
    _sub = ::g::Fuse::Reactive::IExpression::Subscribe(uInterface(uPtr(_expr), ::TYPES[15/*Fuse.Reactive.IExpression*/]), (uObject*)this, _listener);
}
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Instance.Data.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive/1.4.0/ObserverMap.uno
// -----------------------------------------------------------------
...
{
    ::STRINGS[33] = uString::Const("An observable with write-back is expected");
    ::STRINGS[34] = uString::Const("/usr/local/share/uno/Packages/Fuse.Reactive/1.4.0/ObserverMap.uno");
    ::STRINGS[35] = uString::Const("Attach");
    ...
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ::TYPES[4] = ::g::Fuse::IArray_typeof();
    ::TYPES[25] = ::g::Fuse::Reactive::UnmappedView_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetPrecalc(
    ...
    type->SetInterfaces(
        ::TYPES[24/*Fuse.Reactive.IObserver*/], offsetof(ObserverMap_type, interface0));
    type->SetFields(0,
        ::TYPES[23/*Uno.Collections.List`1*/]->MakeType(type->T(0), NULL), offsetof(ObserverMap, _list), 0,
        ::TYPES[6/*Fuse.Reactive.IObservableArray*/], offsetof(ObserverMap, _observable), 0,
        ::TYPES[4/*Fuse.IArray*/], offsetof(ObserverMap, _source), 0,
        ::TYPES[24/*Fuse.Reactive.IObserver*/], offsetof(ObserverMap, _slave), 0,
        ::TYPES[11/*Fuse.Reactive.ISubscription*/], offsetof(ObserverMap, _subscription), 0,
...
void ObserverMap__FuseReactiveIObserverOnNewAll_fn(ObserverMap* __this, uObject* values)
{
    ...
    for (int i = 0; i < ::g::Fuse::IArray::Length(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/])); ++i)
        ::g::Uno::Collections::List__Add_fn(uPtr(__this->_list), __this->Map(::g::Fuse::IArray::Item(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/]), i)));

    __this->OnUpdated();

    if (__this->_slave != NULL)
        ::g::Fuse::Reactive::IObserver::OnNewAll(uInterface(uPtr(__this->_slave), ::TYPES[24/*Fuse.Reactive.IObserver*/]), values);
}
...
void ObserverMap::Attach(uObject* src, uObject* slave)
{
    Detach();
    _source = src;
    _observable = uAs<uObject*>(src, ::TYPES[6/*Fuse.Reactive.IObservableArray*/]);

    if (_observable != NULL)
    {
        _disposable = ::g::Fuse::Reactive::IObservableArray::Subscribe(uInterface(uPtr(_observable), ::TYPES[6/*Fuse.Reactive.IObservableArray*/]), (uObject*)this);
        _subscription = uAs<uObject*>(_disposable, ::TYPES[11/*Fuse.Reactive.ISubscription*/]);

        if (_subscription == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[33/*"An observab...*/], this, ::STRINGS[34/*"/usr/local/...*/], 68, ::STRINGS[35/*"Attach"*/]);
    }

    ::g::Fuse::Reactive::IObserver::OnNewAll(uInterface((uObject*)this, ::TYPES[24/*Fuse.Reactive.IObserver*/]), src);
    _slave = slave;
}
...
void ObserverMap::UpdateBacking()
{
    ...
    ::g::Fuse::Reactive::ISubscription::ReplaceAllExclusive(uInterface(uPtr(_subscription), ::TYPES[11/*Fuse.Reactive.ISubscription*/]), uv);
}
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/Property.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/QuaternaryOperator.uno
// ------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/Resource.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Subscription/ResourceSubscription.uno
// ------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[36] = uString::Const("{Resource ");
    ::STRINGS[20] = uString::Const("} not found in data context");
    ::TYPES[17] = ::g::Uno::Action_typeof();
    ::TYPES[0] = ::g::Uno::IDisposable_typeof();
    ...
    type->SetFields(0,
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(ResourceSubscription, _listener), 0,
...
void ResourceSubscription::ctor_(uObject* source, ::g::Fuse::Node* origin, uString* key, uObject* listener, uType* type)
{
    ...
    _type = type;
    _listener = listener;
    ::g::Fuse::Resources::ResourceRegistry::AddResourceChangedHandler(_key, uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)ResourceSubscription__OnChanged_fn, this));
    OnChanged();
}
...
{
    ClearDiagnostic();
    ::g::Fuse::Resources::ResourceRegistry::RemoveResourceChangedHandler(_key, uDelegate::New(::TYPES[17/*Uno.Action*/], (void*)ResourceSubscription__OnChanged_fn, this));
    _listener = NULL;
    _origin = NULL;
}
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(_origin)->TryGetResource(_key, uDelegate::New(::TYPES[26/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), _source, resource);
    else
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[36/*"{Resource "*/], _key), ::STRINGS[20/*"} not found...*/]), _origin);
}
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/Snapshot.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/TernaryOperator.uno
// ---------------------------------------------------------------------------------
...
static void TernaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(TernaryOperator__Subscription, _listener), 0);
}
...
void TernaryOperator__Subscription::OnNewOperands(uObject* first, uObject* second, uObject* third)
{
    ...
    {
        {
            ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)_to, uPtr(_to)->Compute(first, second, third));
        }
    }
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Expressions/1.4.0/UnaryOperator.uno
// -------------------------------------------------------------------------------
...
{
    ::TYPES[27] = ::g::Fuse::Reactive::VarArgFunction__Argument_typeof()->Array();
    ::TYPES[28] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::Expression_typeof(), NULL);
    ::TYPES[29] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::Expression_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(2,
        ...
        ::TYPES[27/*Fuse.Reactive.VarArgFunction.Argument[]*/], offsetof(VarArgFunction__Subscription, _arguments), 0,
...
void VarArgFunction__Subscription__OnNewData_fn(VarArgFunction__Subscription* __this, uObject* source, uObject* value)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(__this->_func)->Arguments()), ::TYPES[28/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i++)
        if ((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(__this->_func)->Arguments()), ::TYPES[29/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i), &ret2), ret2) == source)
        {
...
void VarArgFunction__Subscription::ctor_1(::g::Fuse::Reactive::VarArgFunction* func, uObject* context)
{
    ctor_();
    _func = func;
    _arguments = uArray::New(::TYPES[27/*Fuse.Reactive.VarArgFunction.Argument[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(func)->Arguments()), ::TYPES[28/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])));
    _context = context;

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(func->Arguments()), ::TYPES[28/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i++)
...
void VarArgFunction__Subscription::Init()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(_func)->Arguments()), ::TYPES[28/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); i++)
        uPtr(uPtr(_arguments)->Strong< ::g::Fuse::Reactive::VarArgFunction__Argument*>(i))->Subscription = uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(_func)->Arguments()), ::TYPES[29/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i), &ret1), ret1))->Subscribe(_context, (uObject*)this);
...
static void Property__Subscription_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(Property__Subscription, _listener), 0);
}
...
{
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)_prop, uPtr(_accessor)->GetAsObject(_object));
}
...
static void QuaternaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(QuaternaryOperator__Subscription, _listener), 0);
}
...
void QuaternaryOperator__Subscription::OnNewOperands(uObject* first, uObject* second, uObject* third, uObject* fourth)
{
    ...
    {
        {
            ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)_qo, uPtr(_qo)->Compute(first, second, third, fourth));
        }
    }
...
static void Snapshot__Subscription_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(Snapshot__Subscription_type, interface1));
    type->SetFields(0,
        ::g::Fuse::Reactive::Snapshot_typeof(), offsetof(Snapshot__Subscription, _snap), 0,
        ::TYPES[2/*Fuse.Reactive.IListener*/], offsetof(Snapshot__Subscription, _listener), 0,
...
void Snapshot__Subscription__FuseReactiveIListenerOnNewData_fn(Snapshot__Subscription* __this, uObject* source, uObject* value)
{
    if (__this->_listener != NULL)
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(__this->_listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)__this->_snap, value);
...
// /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.4.0/Instance.WindowItems.uno
// -----------------------------------------------------------------------------------
...
{
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(listener), ::TYPES[2/*Fuse.Reactive.IListener*/]), (uObject*)this, Compute(operand));
}
...
{
    if (::g::Fuse::IArray::Length(uInterface(uPtr(values), ::TYPES[4/*Fuse.IArray*/])) > 0)
        __this->PushData(::g::Fuse::IArray::Item(uInterface(uPtr(__this->_obs), ::TYPES[4/*Fuse.IArray*/]), 0));
}
...
void ValueObserver::Subscribe(uObject* obs)
{
    ...
    if (::g::Fuse::IArray::Length(uInterface(uPtr(obs), ::TYPES[4/*Fuse.IArray*/])) > 0)
        PushData(::g::Fuse::IArray::Item(uInterface(uPtr(obs), ::TYPES[4/*Fuse.IArray*/]), 0));

    _obsSub = ::g::Fuse::Reactive::IObservableArray::Subscribe(uInterface(uPtr(obs), ::TYPES[6/*Fuse.Reactive.IObservableArray*/]), (uObject*)this);
}
...
uString* VarArgFunction::FormatString(uString* funcName)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Arguments()), ::TYPES[28/*Uno.Collections.ICollection<Fuse.Reactive.Expression>*/])); ++i)
    {
        if (i > 0)
            q = ::g::Uno::String::op_Addition2(q, ::STRINGS[1/*","*/]);

        q = ::g::Uno::String::op_Addition2(q, ::g::Uno::Object::ToString(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Arguments()), ::TYPES[29/*Uno.Collections.IList<Fuse.Reactive.Expression>*/]), uCRef<int>(i), &ret1), ret1))));
    }
