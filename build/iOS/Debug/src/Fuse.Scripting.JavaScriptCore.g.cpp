...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/JavaScriptCore/Array.uno
// --------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/JavaScriptCore/Context.uno
// ----------------------------------------------------------------------------------------
...
::JSValueRef Context::Unwrap1(uObject* obj)
{
    ...
    if (uIs(obj, ::g::Fuse::Scripting::JavaScriptCore::Function_typeof()))
        return ::g::Fuse::Scripting::JavaScriptCore::JSObjectRef::GetJSValueRef((ind16 = uPtr(uCast< ::g::Fuse::Scripting::JavaScriptCore::Function*>(obj, ::g::Fuse::Scripting::JavaScriptCore::Function_typeof()))->_value, ind16));
...
{
    uArray* result = uArray::New(::TYPES[2/*object[]*/], uPtr(values)->Length());
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/JavaScriptCore/Function.uno
// -----------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/JavaScriptCore/JavaScriptCore.uno
// -----------------------------------------------------------------------------------------------
...
static void JSContextRef_build(uType* type)
{
    ...
    type->SetDependencies(
        ::g::Fuse::Scripting::JavaScriptCore::JSValueRef_typeof());
    type->SetInterfaces(
        ::TYPES[1/*Uno.IDisposable*/], offsetof(JSContextRef_type, interface0));
}
            ...
            {
                {
                    ...
                    ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], scriptRef), ::TYPES[1/*Uno.IDisposable*/]));
                    ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], sourceRef), ::TYPES[1/*Uno.IDisposable*/]));
                    return __uno_retval;
                }
                {
                    ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], sourceRef), ::TYPES[1/*Uno.IDisposable*/]));
    ...
    {
        {
            ...
            ::JSValueRef __uno_retval = result;
            ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], strRef), ::TYPES[1/*Uno.IDisposable*/]));
            return __uno_retval;
        }
        {
            ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], strRef), ::TYPES[1/*Uno.IDisposable*/]));
...
static void JSValueRef_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/JavaScriptCore/JavaScriptCore.uno");
    ::STRINGS[6] = uString::Const("str");
    ::TYPES[2] = uObject_typeof()->Array();
    ::TYPES[1] = ::g::Uno::IDisposable_typeof();
    ::TYPES[3] = ::g::Fuse::Scripting::JavaScriptCore::JSStringRef_typeof();
    type->SetDependencies(
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JSValueRef::IsObject(__this, ctx), ::STRINGS[4/*"(&this).IsO...*/], ::STRINGS[5/*"/usr/local/...*/], 31, uArray::Init<uObject*>(::TYPES[2/*object[]*/], 1, uBox(::g::Fuse::Scripting::JavaScriptCore::JSContextRef_typeof(), ctx)));
    ...
    {
        {
            ...
            uString* __uno_retval = ::g::Fuse::Scripting::JavaScriptCore::JSStringRef::ToString(strRef, ::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/]);
            ::g::Uno::IDisposable::Dispose(uInterface(uBox(::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/], strRef), ::TYPES[1/*Uno.IDisposable*/]));
            return __uno_retval;
        }
        {
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/JavaScriptCore/Object.uno
// ---------------------------------------------------------------------------------------
    ...
    {
        {
            ...
            uArray* result = uArray::New(::TYPES[4/*string[]*/], count);

            for (int i = 0; i < count; ++i)
                uPtr(result)->Strong<uString*>(i) = ::g::Fuse::Scripting::JavaScriptCore::JSStringRef::ToString(::g::Fuse::Scripting::JavaScriptCore::JSPropertyNameArray::Item(arr, i), ::TYPES[3/*Fuse.Scripting.JavaScriptCore.JSStringRef*/]);

            uArray* __uno_retval = result;
            ::g::Uno::IDisposable::Dispose(uInterface(uBox(::g::Fuse::Scripting::JavaScriptCore::JSPropertyNameArray_typeof(), arr), ::TYPES[1/*Uno.IDisposable*/]));
