...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/Gesture.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/Pointer.uno
// ----------------------------------------------------------------
...
static void Pointer__CaptureLockImpl_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/Pointer.uno");
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/PointerEvents.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/Focus.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/FocusEvents.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/Focus.Prediction.uno
// -------------------------------------------------------------------------
...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/Gesture.uno");
...
void Gesture::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[9/*"Missing Los...*/], uBox<int>(::g::Uno::Int_typeof(), uPtr(args)->PointIndex())), this, ::STRINGS[10/*"/usr/local/...*/], 281, ::STRINGS[11/*"OnPointerMo...*/]);
        LostCapture(true);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/HitTestHelpers.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/Keyboard.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/PointerEventArgs.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/TextService.uno
// --------------------------------------------------------------------
