...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Set.uno
// -----------------------------------------------------------------
...
{
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::UX::IPropertyListener_typeof(), NULL);
    ::TYPES[4] = ::g::Uno::UX::IPropertyListener_typeof();
    type->SetFields(0,
        ::TYPES[3/*Uno.Collections.List<Uno.UX.IPropertyListener>*/], offsetof(PropertyObject, _propListeners), 0);
}
...
void PropertyObject::AddPropertyListener(uObject* listener)
{
    if (_propListeners == NULL)
        _propListeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[3/*Uno.Collections.List<Uno.UX.IPropertyListener>*/]));
...
{
    OnPropertyChanged1(property, uAs<uObject*>(this, ::TYPES[4/*Uno.UX.IPropertyListener*/]));
}
...
void PropertyObject::OnPropertyChanged1(::g::Uno::UX::Selector property, uObject* origin)
{
    ...
    if (_propListeners != NULL)
        ...
        for (int i = 0; i < uPtr(_propListeners)->Count(); i++)
        {
            ...
            if (listener != origin)
                ::g::Uno::UX::IPropertyListener::OnPropertyChanged(uInterface(uPtr(listener), ::TYPES[4/*Uno.UX.IPropertyListener*/]), this, property_);
        }
}
...
{
    Resource::_globals_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[5/*Uno.Collections.Dictionary<string, Uno.Collections.List<object>>*/]));
    Resource::_listeners_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[6/*Uno.Collections.List<Uno.Action<string>>*/]));
}

static void Resource_build(uType* type)
{
    ::TYPES[5] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL), NULL);
    ::TYPES[6] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), NULL);
    ::TYPES[7] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::String_typeof(), offsetof(Resource, _Key), 0,
        uObject_typeof(), offsetof(Resource, _Value), 0,
        ::TYPES[5/*Uno.Collections.Dictionary<string, Uno.Collections.List<object>>*/], (uintptr_t)&Resource::_globals_, uFieldFlagsStatic,
        ::TYPES[6/*Uno.Collections.List<Uno.Action<string>>*/], (uintptr_t)&Resource::_listeners_, uFieldFlagsStatic);
}
    ...
    {
        {
            ...
            {
                objs = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[7/*Uno.Collections.List<object>*/]);
...
void Selector__Equals_fn(Selector* __this, uType* __type, uObject* obj, bool* __retval)
{
    ...
    uString* s = uAs<uString*>(obj, ::TYPES[8/*string*/]);
...
static void SelectorRegistry__cctor__fn(uType* __type)
{
    ...
    SelectorRegistry::_stringToHandle_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[9/*Uno.Collections.Dictionary<string, int>*/]));
    SelectorRegistry::_handleToString_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[10/*Uno.Collections.Dictionary<int, string>*/]));
    SelectorRegistry::_counter_ = 1;
}

static void SelectorRegistry_build(uType* type)
{
    ::TYPES[9] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Int_typeof(), NULL);
    ::TYPES[10] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof(), NULL);
    type->SetFields(0,
        uObject_typeof(), (uintptr_t)&SelectorRegistry::_mutex_, uFieldFlagsStatic,
        ::TYPES[9/*Uno.Collections.Dictionary<string, int>*/], (uintptr_t)&SelectorRegistry::_stringToHandle_, uFieldFlagsStatic,
        ::TYPES[10/*Uno.Collections.Dictionary<int, string>*/], (uintptr_t)&SelectorRegistry::_handleToString_, uFieldFlagsStatic,
...
static void Size_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[11/*float*/], offsetof(Size, Value), 0,
...
void Size__Equals_fn(Size* __this, uType* __type, uObject* obj, bool* __retval)
{
    ...
    else if (uIs(obj, ::TYPES[11/*float*/]))
    {
        if ((__this->Unit != 2) && (__this->Unit != 1))
            return *__retval = false, void();

        float f = uUnbox<float>(::TYPES[11/*float*/], obj);
...
{
    float ind7;
    return *__retval = ::g::Uno::Float::GetHashCode((ind7 = __this->Value, ind7), ::TYPES[11/*float*/]), void();
}
...
void Size__ToString_fn(Size* __this, uType* __type, uString** __retval)
{
    ...
    {
        case 1:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind1 = __this->Value, ind1), ::TYPES[11/*float*/]), ::STRINGS[5/*" (unspecifi...*/]), void();
        case 2:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind2 = __this->Value, ind2), ::TYPES[11/*float*/]), ::STRINGS[6/*"pt"*/]), void();
        case 3:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind3 = __this->Value, ind3), ::TYPES[11/*float*/]), ::STRINGS[7/*"px"*/]), void();
        case 4:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind4 = __this->Value, ind4), ::TYPES[11/*float*/]), ::STRINGS[8/*"%"*/]), void();
        case 0:
            return *__retval = ::STRINGS[9/*"(auto)"*/], void();
        default:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind5 = __this->Value, ind5), ::TYPES[11/*float*/]), ::STRINGS[10/*" ("*/]), ::g::Uno::Int::ToString((ind6 = __this->Unit, ind6), ::TYPES[12/*int*/])), ::STRINGS[11/*")"*/]), void();
    }
}
...
static void Size2_build(uType* type)
{
    ...
    ::TYPES[13] = ::g::Uno::UX::Size_typeof();
    type->SetFields(0,
        ::TYPES[13/*Uno.UX.Size*/], offsetof(Size2, X), 0,
        ::TYPES[13/*Uno.UX.Size*/], offsetof(Size2, Y), 0);
}
...
void Size2__GetHashCode_fn(Size2* __this, uType* __type, int* __retval)
{
    ::g::Uno::UX::Size ind3;
    ::g::Uno::UX::Size ind4;
    return *__retval = (ind3 = __this->X, (&ind3))->GetHashCode(::TYPES[13/*Uno.UX.Size*/]) ^ (ind4 = __this->Y, (&ind4))->GetHashCode(::TYPES[13/*Uno.UX.Size*/]), void();
}
...
void Size2__ToString_fn(Size2* __this, uType* __type, uString** __retval)
{
    ::g::Uno::UX::Size ind1;
    ::g::Uno::UX::Size ind2;
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((ind1 = __this->X, (&ind1))->ToString(::TYPES[13/*Uno.UX.Size*/]), ::STRINGS[12/*", "*/]), (ind2 = __this->Y, (&ind2))->ToString(::TYPES[13/*Uno.UX.Size*/])), void();
}
    ...
    {
        {
            ...
            ::g::Uno::IDisposable::Dispose(uInterface(uPtr((uObject*)ms), ::TYPES[14/*Uno.IDisposable*/]));
            return __uno_retval;
        }
        {
            ::g::Uno::IDisposable::Dispose(uInterface(uPtr((uObject*)ms), ::TYPES[14/*Uno.IDisposable*/]));
