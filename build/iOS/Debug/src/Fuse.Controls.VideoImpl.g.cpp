...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.4.0/IVideoPlayer.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.4.0/VideoContainer.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.4.0/VideoVisual.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.4.0/VideoDiskCache.uno
// --------------------------------------------------------------------------
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/1.4.0/VideoDiskCache.uno");
...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/1.4.0/VideoLoader.uno
// -----------------------------------------------------------------------
...
static void VideoVisual_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(VideoVisual_type, interface7),
        ...
        ::g::Fuse::Triggers::IMediaPlayback_typeof(), offsetof(VideoVisual_type, interface11),
        ::g::Fuse::Triggers::IPlayback_typeof(), offsetof(VideoVisual_type, interface12),
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(uString::Const("Video error"), e, __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/1.4.0/VideoVisual.uno"), 116, uString::Const("Fuse.Controls.VideoImpl.IVideoCallbacks.OnError"));
}
...
{
    ::g::Fuse::Diagnostics::Unsupported(uString::Const("IPlayback.PlayTo(double) not supported in Fuse.Controls.Video"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Video/1.4.0/VideoVisual.uno"), 186, uString::Const("Fuse.Triggers.IPlayback.PlayTo"));
}
