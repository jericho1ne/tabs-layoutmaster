...
static void ConcurrentQueue_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[0/*Uno.Collections.Queue`1*/]->MakeType(type->T(0), NULL), offsetof(ConcurrentQueue, _queue), 0,
...
void Future1__Invoke_fn(Future1* __this, uType* __type, uDelegate* action, void* arg)
{
    ...
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(__this->_dispatcher), ::g::Uno::Threading::IDispatcher_typeof()), uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)Future1__Closure__Run_fn, (Future1__Closure__New1_fn(__types[0], action, arg, &ret7), ret7)));
}
...
void Future1::ctor_2(uObject* dispatcher)
{
    ...
    State(0);
    _catchables = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[0/*Uno.Collections.Queue`1*/]->MakeType(::g::Uno::Action1_typeof()->MakeType(::TYPES[2/*Uno.Exception*/], NULL), NULL)));
...
void IDispatcherExtensions__Invoke1_fn(uType* __type, uObject* dispatcher, uDelegate* action, void* arg)
{
    ...
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(dispatcher), ::g::Uno::Threading::IDispatcher_typeof()), uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)IDispatcherExtensions__Arg1Invoke__Run_fn, (IDispatcherExtensions__Arg1Invoke__New1_fn(__types[0], action, arg, &ret1), ret1)));
}
...
void IDispatcherExtensions__Invoke11_fn(uType* __type, uObject* dispatcher, uDelegate* func, void* arg)
{
    ...
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(dispatcher), ::g::Uno::Threading::IDispatcher_typeof()), uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)IDispatcherExtensions__Arg1InvokeFunc__Run_fn, (IDispatcherExtensions__Arg1InvokeFunc__New1_fn(__types[0], func, arg, &ret2), ret2)));
}
...
void IDispatcherExtensions__Invoke2_fn(uType* __type, uObject* dispatcher, uDelegate* action, void* arg1, void* arg2)
{
    ...
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(dispatcher), ::g::Uno::Threading::IDispatcher_typeof()), uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)IDispatcherExtensions__Arg2Invoke__Run_fn, (IDispatcherExtensions__Arg2Invoke__New1_fn(__types[0], action, arg1, arg2, &ret3), ret3)));
}
// }
...
{
    ::TYPES[1] = ::g::Uno::Threading::TaskFuture_typeof();
...
static void Task_build(uType* type)
{
    ...
    ::TYPES[3] = ::TYPES[2/*Uno.Exception*/]->Array();
    ::TYPES[4] = ::g::Uno::Threading::ITaskScheduler_typeof();
...
void Task::Execute()
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        Status(1);
        Exception(::g::Uno::AggregateException::New7(uArray::Init< ::g::Uno::Exception*>(::TYPES[3/*Uno.Exception[]*/], 1, e)));
    }
}
...
Task* Task::Run1(uDelegate* taskDelegate, uObject* scheduler)
{
    ...
    ::g::Uno::Threading::ITaskScheduler::ScheduleTask(uInterface(uPtr(scheduler), ::TYPES[4/*Uno.Threading.ITaskScheduler*/]), task);
    return task;
}
// }
...
{
    ::TYPES[5] = ::g::Uno::Threading::TaskDelegate_typeof();
    ::TYPES[2] = ::g::Uno::Exception_typeof();
    type->SetBase(::g::Uno::Threading::Future1_typeof()->MakeType(type->T(0), NULL));
    type->SetDependencies(
...
void TaskFuture::ctor_3(uDelegate* func)
{
    ctor_1();
    _func = func;
    _task = ::g::Uno::Threading::Task::Run(uDelegate::New(::TYPES[5/*Uno.Threading.TaskDelegate*/], (void*)TaskFuture__Invoke1_fn, this));
}
...
static void ThreadPoolTaskScheduler_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Uno::Platform::ApplicationStateTransitionHandler_typeof();
    type->SetDependencies(
...
{
    uPtr(_threadPool)->QueueAction(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)::g::Uno::Threading::Task__Execute_fn, uPtr(task)));
}
...
ThreadPoolTaskScheduler* ThreadPoolTaskScheduler::Default()
{
    if (ThreadPoolTaskScheduler::_default_ == NULL)
    {
        ...
        ::g::Uno::Platform::CoreApp::add_Terminating(uDelegate::New(::TYPES[7/*Uno.Platform.ApplicationStateTransitionHandler*/], (void*)ThreadPoolTaskScheduler__OnAppTerminating_fn));
    }
