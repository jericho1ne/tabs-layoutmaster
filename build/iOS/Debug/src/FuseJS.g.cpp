...
// /usr/local/share/uno/Packages/FuseJS/1.4.0/Base64.uno
// -----------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseJS/1.4.0/Bundle.uno
// -----------------------------------------------------
...
::g::Uno::Threading::Future1* Bundle::Extract(uArray* args)
{
    ...
    uString* ret5;
    bool ret6;
    uString* searchPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(1/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int>(0), ::STRINGS[23/*""*/], &ret4), ret4);
    uString* destinationPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(1/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int>(1), ::STRINGS[23/*""*/], &ret5), ret5);
...
{
    uString* ret8;
    uString* searchPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(1/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int>(0), ::STRINGS[23/*""*/], &ret8), ret8);
...
// /usr/local/share/uno/Packages/FuseJS/1.4.0/Environment.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseJS/1.4.0/FileReader.uno
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseJS/1.4.0/Globals.uno
// ------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseJS/1.4.0/Latin1Helpers.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseJS/1.4.0/Lifecycle.uno
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseJS/1.4.0/UserEvents.uno
// ---------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[51] = uString::Const("/usr/local/share/uno/Packages/FuseJS/1.4.0/UserEvents.uno");
