// This file was generated based on '/Users/mpeteu/Library/Application Support/Fusetools/Packages/Fuse.Maps/1.4.0/MapView.uno'.
...
struct IMapView
{
    ...
    void(*fp_HandleMarkerTapped)(uObject*, int*, uString*);
    ...
    static void HandleMarkerTapped(const uInterface& __this, int id, uString* label) { __this.VTable<IMapView>()->fp_HandleMarkerTapped(__this, &id, label); }
