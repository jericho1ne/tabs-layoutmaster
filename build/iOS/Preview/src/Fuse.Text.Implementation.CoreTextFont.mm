// This file was generated based on /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Implementation/CoreTextFontFace.uno.
...
static void CoreTextFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/Implementation/CoreTextFontFace.uno");
...
uArray* CoreTextFont::TryConvertRGBAToL8(uArray* buffer)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == 0, ::STRINGS[0/*"(buffer.Len...*/], ::STRINGS[1/*"/usr/local/...*/], 171, uArray::Init<uObject*>(::TYPES[0/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
