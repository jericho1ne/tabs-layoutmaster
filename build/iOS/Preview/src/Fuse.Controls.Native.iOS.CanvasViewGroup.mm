// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/iOS/CanvasViewGroup.uno.
...
static void CanvasViewGroup_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/iOS/CanvasViewGroup.uno");
