...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Enums.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.Transform.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/AspectBoxSizing.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.UnoHostInterface.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/BoxSizing.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.Layout.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Caching/Cache.Heuristic.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Caching/Cache.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Caching/ElementAtlasPool.uno
// ------------------------------------------------------------------------------
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Draw called on a non-rooted node"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.Drawing.uno"), 67, uString::Const("Draw"));
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn_)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid values in ArrangeMarginBox"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.Layout.uno"), 262, uString::Const("OnArrangeMarginBox"));
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("CaptureRegion bigger than maximum texture size, dropping rendering (size: "), uBox(::g::Uno::Int2_typeof(), fsz)), uString::Const(", max-size: ")), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 0, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.Drawing.uno"), 40);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(uString::Const("This element has a partial opacity and is not flat. This will not render correctly. Put the opacity on a flat child panel instead."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.Effects.uno"), 117, uString::Const("Composit"));
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("This element can not be drawn."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.Effects.uno"), 125, uString::Const("Composit"));
    }
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Caching/ElementAtlas.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Caching/ElementBatch.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Caching/ElementBatcher.uno
// ----------------------------------------------------------------------------
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Caching/ElementBatcher.uno");
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/LayoutFunctions.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.HitTest.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/InteractiveTransform.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Element.ITreeRenderer.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/LayoutMasterAttr.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/LayoutMasterBoxSizing.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/LimitBoxSizing.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Transforms.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/1.4.0/Viewport.uno
// --------------------------------------------------------------
