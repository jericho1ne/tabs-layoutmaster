...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.0/Resources/DisposalPolicy.uno
// ----------------------------------------------------------------------------
...
static void ImageSource_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Resources/ImageSource.uno");
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/ResourceSetter.uno
// -----------------------------------------------------------------
