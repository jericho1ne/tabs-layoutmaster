...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Bidirectional.uno
// ---------------------------------------------------------------
...
::g::Fuse::Text::SinglyLinkedList* Runs::GetVisual(::g::Fuse::Text::SinglyLinkedList* run)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert4 >= 1, uString::Const("ranges.Count >= 1"), uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/Bidirectional.uno"), 98, uArray::Init<uObject*>(uObject_typeof()->Array(), 2, uBox<int>(::g::Uno::Int_typeof(), assert4), uBox<int>(::g::Uno::Int_typeof(), 1)));
...
::g::Uno::Collections::List* Runs::GetVisual1(::g::Uno::Collections::List* runs)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == assert2, uString::Const("result.Count == runs.Count"), uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/Bidirectional.uno"), 45, uArray::Init<uObject*>(uObject_typeof()->Array(), 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), assert2)));
    return result;
}
...
void Runs::MergeRange(::g::Uno::Collections::Stack* ranges, Runs__Range* range)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert5 >= 1, uString::Const("ranges.Count >= 1"), uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/Bidirectional.uno"), 118, uArray::Init<uObject*>(uObject_typeof()->Array(), 2, uBox<int>(::g::Uno::Int_typeof(), assert5), uBox<int>(::g::Uno::Int_typeof(), 1)));
    Runs__Range* previous = (::g::Uno::Collections::Stack__Peek_fn(ranges, &ret12), ret12);
    ::g::Uno::Diagnostics::Debug::Assert(uPtr(previous)->Level < uPtr(range)->Level, uString::Const("previous.Level < range.Level"), uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/Bidirectional.uno"), 122, uArray::Init<uObject*>(uObject_typeof()->Array(), 2, uBox<int>(::g::Uno::Int_typeof(), uPtr(previous)->Level), uBox<int>(::g::Uno::Int_typeof(), uPtr(range)->Level)));
