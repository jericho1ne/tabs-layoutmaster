...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.4.0/Enums.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.4.0/Brush.uno
// ----------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing/1.4.0/Brush.uno");
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.4.0/Colors.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/CoreGraphics/CoreGraphicsSurface.uno
// ---------------------------------------------------------------------------------------------
...
static void CoreGraphicsSurface_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/CoreGraphics/CoreGraphicsSurface.uno");
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/DrawObjectWatcher.uno
// ------------------------------------------------------------------------------
...
static void DrawObjectWatcher__cctor__fn(uType* __type)
{
    ...
    DrawObjectWatcher::ShadingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[34/*"Shading"*/]);
}
...
void DrawObjectWatcher::Sync()
{
    ...
    if (!_rooted)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Sync while not rooted"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/DrawObjectWatcher.uno"), 39, uString::Const("Sync"));
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Drawing/ImageFill.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.4.0/Brushes/LinearGradient.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/CoreGraphics/GraphicsSurface.uno
// -----------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/SurfaceManager.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.4.0/Brushes/SolidColor.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/Surface.uno
// --------------------------------------------------------------------
...
static void LinearGradient_build(uType* type)
{
    ...
    ::TYPES[18] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(9/*ToArray<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    type->SetDependencies(
    ...
    type->Reflection.SetFunctions(16,
        ...
        new uFunction(".ctor", NULL, (void*)LinearGradient__New3_fn, 0, true, type, 1, ::TYPES[12/*Fuse.Drawing.GradientStop[]*/]),
        new uFunction("get_SortedStops", NULL, (void*)LinearGradient__get_SortedStops_fn, 0, false, ::TYPES[12/*Fuse.Drawing.GradientStop[]*/], 0),
        ...
        new uFunction("get_Stops", NULL, (void*)LinearGradient__get_Stops_fn, 0, false, ::TYPES[16/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/], 0));
}
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/LineMetrics.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/LineParser.uno
// -----------------------------------------------------------------------
...
static void LineParser_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/LineParser.uno");
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/LineSegment.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/LineSegments.uno
// -------------------------------------------------------------------------
...
static void LineSegments_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[5/*Uno.Collections.IList<Fuse.Drawing.LineSegment>*/], offsetof(LineSegments, _Segments), 0);
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/CoreGraphics/NativeSurface.uno
// ---------------------------------------------------------------------------------------
...
{
    ::STRINGS[33] = uString::Const("NativeSurface.Begin was not called");
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Drawing::CoreGraphicsSurface_type, interface0));
    type->SetFields(11,
...
void NativeSurface__VerifyBegun_fn(NativeSurface* __this)
{
    ...
    if (::g::Uno::IntPtr::op_Equality(__this->_cgContext, ::g::Uno::IntPtr::Zero_))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[33/*"NativeSurfa...*/]));
}
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.4.0/Stroke.uno
// -----------------------------------------------------------
...
static void Stroke__cctor__fn(uType* __type)
{
    ...
    Stroke::_lineJoinMiterLimitName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[41/*"LineJoinMit...*/]);
}
...
static void Stroke_build(uType* type)
{
    ...
    ::STRINGS[41] = uString::Const("LineJoinMiterLimit");
...
{
    ::STRINGS[42] = uString::Const("GLDraw called with mismatched elements");
    ::STRINGS[43] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/Surface.uno");
    ::STRINGS[44] = uString::Const("Draw");
...
void Surface::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* elm, uObject* drawable)
{
    ...
    if (elm != drawable)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[42/*"GLDraw call...*/], this, ::STRINGS[43/*"/usr/local/...*/], 118, ::STRINGS[44/*"Draw"*/]);
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.4.0/SurfaceUtil.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/1.4.0/WindingRules.uno
// -----------------------------------------------------------------
