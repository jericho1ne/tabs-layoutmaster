...
{
    uStackFrame __("TabsLayoutMaster_accessor_Tab_Text", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("TabsLayoutMaster_accessor_Tab_Text", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
