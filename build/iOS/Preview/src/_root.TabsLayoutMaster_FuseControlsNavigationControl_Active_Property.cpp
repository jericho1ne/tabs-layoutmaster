...
{
    uStackFrame __("TabsLayoutMaster_FuseControlsNavigationControl_Active_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("TabsLayoutMaster_FuseControlsNavigationControl_Active_Property", "Set(Uno.UX.PropertyObject,Fuse.Visual,Uno.UX.IPropertyListener)");
