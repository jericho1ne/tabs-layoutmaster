...
// /usr/local/share/uno/Packages/Fuse.Testing/1.4.0/JavaScriptTest.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Testing/1.4.0/TestRootPanel.uno
// ------------------------------------------------------------------
    ...
    {
        {
            ...
            catch (const uThrowable& __t)
            {
                ...
                if (testFailedException != NULL)
                    ::g::Uno::Testing::Assert::Fail(uPtr(testFailedException)->Message(), uString::Const("/usr/local/share/uno/Packages/Fuse.Testing/1.4.0/TestRootPanel.uno"), 115, uString::Const("RunTest"));
                else
                    throw __t;
            }
        }
    ...
    {
        {
            while (enum2.MoveNext(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Diagnostic_typeof(), NULL)))
            {
                ...
                ::g::Uno::Testing::Assert::Fail(uPtr(e1)->ToString(), uString::Const("/usr/local/share/uno/Packages/Fuse.Testing/1.4.0/TestRootPanel.uno"), 127, uString::Const("RunTest"));
            }
        }
        {
