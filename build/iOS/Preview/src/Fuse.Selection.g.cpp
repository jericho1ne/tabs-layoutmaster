...
// /usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selected.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selectable.ScriptClass.uno
// -----------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selectable.ScriptClass.uno");
    ::STRINGS[6] = uString::Const("No selection, perhaps not rooted");
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selectable.uno");
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.ScriptClass.uno
// ----------------------------------------------------------------------------
...
void Selection__FuseReactiveIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(message, __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.uno"), 495, uString::Const("Fuse.Reactive.IObserver.OnFailed"));
}
...
void Selection__FuseReactiveIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.uno"), 485, uString::Const("Fuse.Reactive.IObserver.OnInsertAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.uno"), 450, uString::Const("Fuse.Reactive.IObserver.OnNewAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.uno"), 474, uString::Const("Fuse.Reactive.IObserver.OnRemoveAt"));
        return;
    }
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("MaxCount must >= 1"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.uno"), 138, uString::Const("set_MaxCount"), NULL);
        return;
    }
...
void Selection::OnSelectionChanged(int how)
{
    ...
    if ((how == 0) && (_subscription != NULL))
    {
        ...
        if (sub != NULL)
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Selection changed, but the bound collection is not writeable."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.uno"), 360, uString::Const("OnSelectionChanged"));
    }
}
...
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Values` must be an IObservableArray"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.uno"), 394, uString::Const("set_Values"), NULL);
        return;
    }
...
void Selection::add(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("add requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.ScriptClass.uno"), 49, ::STRINGS[1/*"add"*/], NULL);
        return;
    }
...
void Selection::clear(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("clear requires 0 arguments"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.ScriptClass.uno"), 31, uString::Const("clear"), NULL);
        return;
    }
...
void Selection::forceAdd(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceAdd requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.ScriptClass.uno"), 81, uString::Const("forceAdd"), NULL);
        return;
    }
...
void Selection::forceRemove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceRemove requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.ScriptClass.uno"), 95, uString::Const("forceRemove"), NULL);
        return;
    }
...
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("remove requires 1 argument, the value of the item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.ScriptClass.uno"), 67, ::STRINGS[2/*"remove"*/], NULL);
        return;
    }
...
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("toggle requires 1 argument, the value of them item"), s, uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selection.ScriptClass.uno"), 111, ::STRINGS[3/*"toggle"*/], NULL);
        return;
    }
...
static void SelectionEvent_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/Selected.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
...
void SelectionEvent__OnRooted_fn(SelectionEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[15/*"Unable to l...*/], __this, ::STRINGS[16/*"/usr/local/...*/], 41, ::STRINGS[10/*"OnRooted"*/], NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.4.0/ToggleSelection.uno
// ----------------------------------------------------------------------
...
static void ToggleSelection_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/ToggleSelection.uno");
...
// /usr/local/share/uno/Packages/Fuse.Selection/1.4.0/WhileSelected.uno
// --------------------------------------------------------------------
...
{
    ::STRINGS[15] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Selection/1.4.0/WhileSelected.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[4] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[15/*"Unable to l...*/], __this, ::STRINGS[21/*"/usr/local/...*/], 26, ::STRINGS[10/*"OnRooted"*/], NULL);
        return;
    }
