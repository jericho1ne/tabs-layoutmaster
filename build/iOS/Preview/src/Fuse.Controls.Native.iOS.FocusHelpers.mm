...
void FocusHelpers::ScheduleBecomeFirstResponder(::g::ObjC::Object* target)
{
    ...
    ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::g::Uno::Action_typeof(), (void*)FocusHelpers__PerformBecomeFirstResponder__BecomeFirstResponder_fn, FocusHelpers__PerformBecomeFirstResponder::New1(target)), 0, 1);
}
...
void FocusHelpers::ScheduleResignFirstResponder(::g::ObjC::Object* target)
{
    ...
    ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::g::Uno::Action_typeof(), (void*)::g::Fuse::Controls::Native::iOS::KeyboardView__HideKeyboard_fn, uPtr(FocusHelpers::KeyboardView())), 0, 1);
}
