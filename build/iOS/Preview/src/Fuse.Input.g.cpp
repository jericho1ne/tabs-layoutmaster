...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/Gesture.uno");
...
static void PointerEventArgs_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.0/Input/PointerEventArgs.uno");
