...
#include <Fuse.Scripting.DateTimeConverterHelpers.h>
...
#include <Fuse.Scripting.Observable.Subscription.ClearExclusiveOperation.h>
#include <Fuse.Scripting.Observable.Subscription.h>
#include <Fuse.Scripting.Observable.Subscription.ReplaceAllExclusiveOperation.h>
#include <Fuse.Scripting.Observable.Subscription.SetExclusiveOperation.h>
...
#include <Fuse.Scripting.ThreadWorker.ContextIgnoringAction.h>
#include <Fuse.Scripting.ThreadWorker.Fence.h>
#include <Fuse.Scripting.ThreadWorker.h>
#include <Fuse.Scripting.ThreadWorker.MethodClosure.h>
#include <Fuse.Scripting.ThreadWorker.PropertyClosure.h>
#include <Fuse.Scripting.ThreadWorker.ReadonlyPropertyClosure.h>
...
// /usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/JSCallback.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/Observable.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ArrayMirror.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/FunctionMirror.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ClassInstance.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ThreadWorker.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ThreadWorker.Wrapping.uno
// ---------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/DiagnosticSubject.uno
// -----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/EventEmitterModule.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/ScriptModule.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ValueMirror.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ObservableProperty.uno
// ------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ThreadWorker.ScriptClass.uno
// ------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ModuleInstance.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/ModuleResult.uno
// -------------------------------------------------------------------
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[39] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/NativeEvent.uno");
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[38/*"this.Contex...*/], ::STRINGS[39/*"/usr/local/...*/], 46, uArray::New(::TYPES[16/*object[]*/], 0));
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ObjectMirror.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/ScriptModule.Require.uno
// ---------------------------------------------------------------------------
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[76] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/ScriptModule.Require.uno");
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[74/*"JavaScript ...*/], path), ::STRINGS[75/*" was fixed!"*/]), this, ::STRINGS[76/*"/usr/local/...*/], 73, ::STRINGS[77/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[74/*"JavaScript ...*/], path), ::STRINGS[78/*" line "*/]), uBox<int>(::TYPES[55/*int*/], uPtr(e)->LineNumber())), ::STRINGS[79/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[76/*"/usr/local/...*/], 83, ::STRINGS[77/*"Require"*/], NULL);
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/RootableScriptModule.uno
// --------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/ScriptException.uno
// ----------------------------------------------------------------------
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Cannot call a non-void method asynchronously"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/1.4.0/ScriptClass.uno"), 107, uString::Const("Call"));
            return *__retval = NULL, void();
        }
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null object"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/Observable.uno"), 118, uString::Const("SetExclusive"));
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/SubscriptionSubject.uno
// -------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ThreadWorker.Mirror.uno
// -------------------------------------------------------------------------------------
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(uString::Const("Skipped Exception"), prev, this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ThreadWorker.uno"), 188, uString::Const("CheckAndThrow"));
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ThreadWorker.Mirror.uno"), 41, uString::Const("CreateMirror"));
        return NULL;
    }
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(uString::Const("ThreadWorked failed"), e, this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/ThreadWorker.uno"), 86, uString::Const("Run"));
