...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Renderer.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Substring.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Implementation/SinglyLinkedList.uno
// ---------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Fallback.uno
// ----------------------------------------------------------
...
static void FallingBackFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/Fallback.uno");
...
void FallingBackFont__Shape_fn(FallingBackFont* __this, ::g::Fuse::Text::Substring* text, int* fontIndex, int* dir, uArray** __retval)
{
    ...
    int dir_ = *dir;
    ::g::Uno::Diagnostics::Debug::Assert(fontIndex_ == 0, ::STRINGS[2/*"fontIndex =...*/], ::STRINGS[1/*"/usr/local/...*/], 76, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), fontIndex_), uBox<int>(::g::Uno::Int_typeof(), 0)));
...
void FallingBackFont::ctor_1(uArray* fonts)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[0/*"fonts.Lengt...*/], ::STRINGS[1/*"/usr/local/...*/], 45, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
    Fonts = fonts;
}
...
void FallingBackFontFace::ctor_1(uArray* fontFaces)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[3/*"fontFaces.L...*/], ::STRINGS[1/*"/usr/local/...*/], 13, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
    FontFaces = fontFaces;
}
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/FontFace.uno
// ----------------------------------------------------------
...
static void Font_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/FontFace.uno");
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/GlyphAtlas.uno
// ------------------------------------------------------------
...
static void GlyphAtlas_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/GlyphAtlas.uno");
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/LazyFontFace.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/LineBreaks.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Measure.uno
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/ShapedRun.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Shape.uno
// -------------------------------------------------------
...
static void SubstringExtensions_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/Substring.uno");
...
::g::Fuse::Text::Substring* SubstringExtensions::InclusiveRange(::g::Fuse::Text::Substring* s, int start, int end)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(end < s->Length, ::STRINGS[16/*"end < s.Len...*/], ::STRINGS[15/*"/usr/local/...*/], 298, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), end), uBox<int>(::g::Uno::Int_typeof(), s->Length)));
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/TextureAtlas.uno
// --------------------------------------------------------------
...
static void TextureAtlas_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.4.0/TextureAtlas.uno");
...
::g::Fuse::Text::SubTexture TextureAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == _format, ::STRINGS[18/*"bitmap.Form...*/], ::STRINGS[19/*"/usr/local/...*/], 50, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Graphics::Format_typeof(), assert1), uBox<int>(::g::Uno::Graphics::Format_typeof(), _format)));
...
void TextureAtlas::Blit(::g::Uno::Content::Images::Bitmap* dst, ::g::Uno::Content::Images::Bitmap* src, ::g::Uno::Int2 dstPos)
{
    ...
    assert3 = src->Format();
    assert4 = dst->Format();
    ::g::Uno::Diagnostics::Debug::Assert(assert3 == assert4, ::STRINGS[22/*"src.Format ...*/], ::STRINGS[19/*"/usr/local/...*/], 97, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Graphics::Format_typeof(), assert3), uBox<int>(::g::Uno::Graphics::Format_typeof(), assert4)));
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Truncate.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Text/1.4.0/Wrap.uno
// ------------------------------------------------------
