...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/Android/Button.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.DatePicker/1.4.0/Android/DatePicker.uno
// -----------------------------------------------------------------------------------
...
// public DatePickerView(Fuse.Controls.IDatePickerHost host) :14
void DatePickerView__ctor__fn(DatePickerView* __this, uObject* host)
{
    __this->ctor_(host);
}

// public DatePickerView New(Fuse.Controls.IDatePickerHost host) :14
void DatePickerView__New1_fn(uObject* host, DatePickerView** __retval)
{
    *__retval = DatePickerView::New1(host);
}

// public DatePickerView(Fuse.Controls.IDatePickerHost host) [instance] :14
void DatePickerView::ctor_(uObject* host)
{
}

// public DatePickerView New(Fuse.Controls.IDatePickerHost host) [static] :14
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/Android/GraphicsView.uno
// ---------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/Android/ScrollView.uno
// -------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/Android/Slider.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/Android/SurfaceView.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/Android/Switch.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/Android/TextureView.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/Android/TextView.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.TimePicker/1.4.0/Android/TimePicker.uno
// -----------------------------------------------------------------------------------
...
// public TimePickerView(Fuse.Controls.ITimePickerHost host) :14
void TimePickerView__ctor__fn(TimePickerView* __this, uObject* host)
{
    __this->ctor_(host);
}

// public TimePickerView New(Fuse.Controls.ITimePickerHost host) :14
void TimePickerView__New1_fn(uObject* host, TimePickerView** __retval)
{
    *__retval = TimePickerView::New1(host);
}

// public TimePickerView(Fuse.Controls.ITimePickerHost host) [instance] :14
void TimePickerView::ctor_(uObject* host)
{
}

// public TimePickerView New(Fuse.Controls.ITimePickerHost host) [static] :14
