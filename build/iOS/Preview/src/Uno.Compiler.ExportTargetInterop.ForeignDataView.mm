...
// private static ObjC.Object CreateNSDataFromByteArray(Uno.IntPtr rawUnoArray) :51
...
// private ForeignDataView New(Uno.Buffer buffer) :28
...
// private ForeignDataView(Uno.Buffer buffer) [instance] :28
...
// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(byte[] unoArray) [static] :35
ForeignDataView* ForeignDataView::Create1(uArray* unoArray)
{
    return ForeignDataView::New4(unoArray);
}

// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(sbyte[] unoArray) [static] :40
ForeignDataView* ForeignDataView::Create2(uArray* unoArray)
{
    return ForeignDataView::New5(unoArray);
}

// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(Uno.Buffer unoBuffer) [static] :45
ForeignDataView* ForeignDataView::Create3(::g::Uno::Buffer* unoBuffer)
{
    return ForeignDataView::New6(unoBuffer);
}

// private static ObjC.Object CreateNSDataFromByteArray(Uno.IntPtr rawUnoArray) [static] :51
...
// private ForeignDataView New(Uno.Buffer buffer) [static] :28
