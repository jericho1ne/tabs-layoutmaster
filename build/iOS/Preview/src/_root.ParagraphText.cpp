// This file was generated based on /Users/mpeteu/Sites/tabs-layoutmaster/build/iOS/Preview/cache/ux13/ParagraphText.g.uno.
...
// public partial sealed class ParagraphText :2
// {
// static ParagraphText() :4
static void ParagraphText__cctor_4_fn(uType* __type)
{
}

static void ParagraphText_build(uType* type)
{
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ParagraphText__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::TextControl_type* ParagraphText_typeof()
{
    ...
    options.ObjectSize = sizeof(ParagraphText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("ParagraphText", options);
    type->fp_build_ = ParagraphText_build;
    type->fp_ctor_ = (void*)ParagraphText__New4_fn;
    type->fp_cctor_ = ParagraphText__cctor_4_fn;
...
// public ParagraphText() :8
void ParagraphText__ctor_8_fn(ParagraphText* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void ParagraphText__InitializeUX1_fn(ParagraphText* __this)
{
    __this->InitializeUX1();
}

// public ParagraphText New() :8
void ParagraphText__New4_fn(ParagraphText** __retval)
{
    *__retval = ParagraphText::New4();
}

// public ParagraphText() [instance] :8
void ParagraphText::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void ParagraphText::InitializeUX1()
{
    uStackFrame __("ParagraphText", "InitializeUX()");
    TextWrapping(1);
    LineSpacing(8.0f);
    FontSize(12.0f);
    TextAlignment(0);
...
// public ParagraphText New() [static] :8
ParagraphText* ParagraphText::New4()
{
    ParagraphText* obj1 = (ParagraphText*)uNew(ParagraphText_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
