...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/FuseJS/Builtins.uno
// ---------------------------------------------------------------------------------
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::setTimeout3cb1c828())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[5/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::es6promisemin1d406430())->ReadAllText());
    context->Evaluate(::STRINGS[5/*"fuse-builti...*/], ::STRINGS[6/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Diagnosticsc596c245()))->EvaluateExports(context, ::STRINGS[7/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Observable960b6d22()))->EvaluateExports(context, ::STRINGS[8/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.0/FuseJS/DiagnosticsImpl.uno");
