// This file was generated based on /usr/local/share/uno/Packages/Fuse.Common/1.4.0/GraphicsWorker.uno.
...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Common/1.4.0/GraphicsWorker.uno");
