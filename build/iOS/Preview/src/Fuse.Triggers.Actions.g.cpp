...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Triggers/Actions/BringIntoView.uno
// ------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/1.4.0/Triggers/BringToFront.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Callback.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/CancelInteractions.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Visibility.uno
// ------------------------------------------------------------------------
...
static void Collapse_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Visibility.uno");
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/DebugAction.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/DebugProperty.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.4.0/EvaluateJS.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Focus.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Toggle.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.4.0/WebViewNavActions.uno
// -------------------------------------------------------------------------------
...
static void PlayTo_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Playback.uno");
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Pulse.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/1.4.0/RaiseUserEvent.uno
// ----------------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.4.0/RaiseUserEvent.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.4.0/NavigationActions.uno
// ----------------------------------------------------------------------------------
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.4.0/NavigationActions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/TimelineAction.uno
// ----------------------------------------------------------------------------
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/TimelineAction.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(9,
...
static void Toggle_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/Toggle.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
static void TransitionLayout_build(uType* type)
{
    ...
    ::STRINGS[26] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.0/Triggers/LayoutAnimation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::Action_typeof();
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/StateTransition.uno
// -----------------------------------------------------------------------------
...
static void TransitionState_build(uType* type)
{
    ...
    ::STRINGS[28] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/StateTransition.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(9,
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/TriggerAction.uno
// ---------------------------------------------------------------------------
...
static void TriggerAction_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.0/Actions/TriggerAction.uno");
