// This file was generated based on /Users/mpeteu/Sites/tabs-layoutmaster/build/iOS/Preview/cache/ux13/H1Text.g.uno.
...
static void H1Text_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)H1Text__New4_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("H1Text", "InitializeUX()");
    TextWrapping(1);
    FontSize(20.0f);
    TextAlignment(0);
    Alignment(5);
