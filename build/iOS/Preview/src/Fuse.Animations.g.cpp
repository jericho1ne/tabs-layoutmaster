...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/TriggerAnimation.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Animator.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Attract.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Attractor.uno
// -----------------------------------------------------------------
...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Attractor.uno");
...
void Attractor::Motion(::g::Fuse::Motion::DestinationMotion* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[1/*"Motion shou...*/], this, ::STRINGS[2/*"/usr/local/...*/], 51, ::STRINGS[3/*"set_Motion"*/], NULL);
}
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/AverageMixer.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.0/Easing.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Change.uno
// --------------------------------------------------------------
...
static void ContinuousTrackChangeState_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Change.uno");
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/TrackAnimator.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Cycle.uno
// -------------------------------------------------------------
...
static void CycleState_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Cycle.uno");
    ::TYPES[12] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[5] = ::g::Fuse::Internal::BlenderMap_typeof();
    ::TYPES[13] = ::g::Fuse::Animations::IMixerHandle_typeof();
    type->SetDependencies(
...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"Invalid seek"*/], 0, ::STRINGS[9/*"/usr/local/...*/], 258);
...
// /usr/local/share/uno/Packages/Fuse.Motion/1.4.0/DestinationBehavior.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/DiscreteKeyframeTrack.uno
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/DiscreteMixer.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/DiscreteSingleTrack.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/EasingTrack.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Mixer.uno
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Resize.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Keyframe.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/SplineTrack.uno
// -------------------------------------------------------------------
...
static void MasterProperty_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Mixer.uno");
...
void MixerHandle__Set_fn(MixerHandle* __this, void* value, float* strength)
{
    ...
    if (__this->Master == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[15/*"invalid Mix...*/], 0, ::STRINGS[13/*"/usr/local/...*/], 392);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/TransformAnimator.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Nothing.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/OpenAnimator.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Player.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/RangeAdapter.uno
// --------------------------------------------------------------------
...
static void ResizeAnimatorState_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Resize.uno");
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Resize star...*/], r, ::STRINGS[19/*"/usr/local/...*/], 98, ::STRINGS[20/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[21/*"Resize star...*/], r, ::STRINGS[19/*"/usr/local/...*/], 106, ::STRINGS[20/*".ctor"*/]);
        _valid = false;
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Spin.uno
// ------------------------------------------------------------
...
{
    ::STRINGS[8] = uString::Const("Invalid seek");
    ::STRINGS[22] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Spin.uno");
    ::TYPES[12] = ::g::Fuse::Animations::IMixer_typeof();
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"Invalid seek"*/], 0, ::STRINGS[22/*"/usr/local/...*/], 76);
        return *__retval = true, void();
    }
...
static void Attract__Subscription_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.0/Attract.uno");
...
void Attract__Subscription::NeedSim(int size)
{
    ...
    if ((size < 0) || (size > 4))
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[23/*"Unexpected ...*/], uBox<int>(::g::Uno::Int_typeof(), size)), this, ::STRINGS[24/*"/usr/local/...*/], 134, ::STRINGS[25/*"NeedSim"*/]);
        return;
    }
...
{
    ::STRINGS[8] = uString::Const("Invalid seek");
    ::STRINGS[26] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/1.4.0/TransformAnimator.uno");
    ::TYPES[12] = ::g::Fuse::Animations::IMixer_typeof();
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"Invalid seek"*/], 0, ::STRINGS[26/*"/usr/local/...*/], 171);
        return;
    }
