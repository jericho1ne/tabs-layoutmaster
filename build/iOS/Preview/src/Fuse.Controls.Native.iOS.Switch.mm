// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.4.0/iOS/Switch.uno.
...
static void Switch_build(uType* type)
{
    ...
    type->SetFields(10,
        ::TYPES[2/*Fuse.Controls.Native.IToggleViewHost*/], offsetof(Switch, _host), 0,
        ::TYPES[1/*Uno.IDisposable*/], offsetof(Switch, _valueChangedEvent), 0);
