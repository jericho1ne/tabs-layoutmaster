...
// /usr/local/share/uno/Packages/UnoCore/1.4.3/Source/Uno/Graphics/FormatHelpers.uno
// ---------------------------------------------------------------------------------
...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/UnoCore/1.4.3/Source/Uno/Graphics/Texture2D.uno");
...
// public void Update(Uno.IntPtr mip0) :224
...
// public void Update(Uno.IntPtr mip0) [instance] :224
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[4/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[5/*"**** Invali...*/], versionString), 0, ::STRINGS[6/*"/usr/local/...*/], 114);
            }
            else             throw __t;
        }
    }
...
// /usr/local/share/uno/Packages/UnoCore/1.4.3/Source/Uno/Graphics/TextureCube.uno
// -------------------------------------------------------------------------------
