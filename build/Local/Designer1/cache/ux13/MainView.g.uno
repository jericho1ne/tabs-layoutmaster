...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp41 = new global::Fuse.Reactive.JavaScript(__g_nametable);
        ...
        var temp46 = new global::H1Text();
        var temp47 = new global::H1Text();
        var temp48 = new global::H1Text();
        var temp49 = new global::ParagraphText();
        ...
        temp45.Children.Add(temp51);
        temp46.Value = "Find Artisanal Coffee Nearby.";
        temp47.Value = "Read reviews you trust.";
        temp48.Value = "Sip as much as you want.";
        temp49.Value = "FindSomeCoffee is your guidebook to the best local artisanal coffee. Whether your drink of choice is a pour-over, cortado, nitro cold brew, or a raktajino - we will help you find the best cup of coffee in your neighborhood.";
        temp50.Value = "No coffee shop gets a review after one or two visits. We visit our baristas until they smile when we walk in and say “you _have_ to try what I’m making today.”";
        temp51.Value = "The baristas are our inspiration and we review the experience of drinking their artisanal coffee.";
